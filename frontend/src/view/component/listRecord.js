        ...
        return(
            <tbody>
                <tr style={{textAlign: 'center'}}>
                    ...
                    <td><a href={this.props.obj.id}><button type="button" className='btn btn-primary'><i class="fas fa-eye"></i> See</button></a></td>
                    <td><button type="button" className='btn btn-danger' data-bs-toggle="modal" data-bs-target={"#myModal"+this.props.obj.id}><i class="fas fa-trash-alt"></i> Erase</button></td>
                </tr>
                <div class="modal fade" id={"myModal"+this.props.obj.id}>
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3><i class="fas fa-question-circle"></i> Notification</h3>
                                <button type="button" class="close" data-bs-dismiss="modal">&times;</button>
                            </div>
                            <div class="modal-body">
                                <form onSubmit={this.handleDelete}>
                                    <h2 style={{textAlign: 'center', color: 'red', fontSize: '70px'}}><i class="fas fa-exclamation-circle"></i></h2>
                                    <h4 style={{textAlign: 'center',}}>Are you sure you want to delete this profile??</h4>
                                    <p style={{textAlign: 'center'}}>Please enter again <strong className='text-danger' style={{fontSize: 18}}>{this.props.obj.id}</strong> enter <strong>cell below</strong> to delete this profile</p>
                                    ...
                                    <div class="w3-panel w3-pale-red w3-leftbar w3-rightbar w3-border-red">
                                        <h5 style={{ marginTop: 10 }}><i class="fas fa-exclamation-triangle" style={{color: 'red',}}></i><strong style={{color: 'red', marginLeft: '5px'}}> Warning</strong></h5>
                                        <p style={{color: 'red', marginLeft: '2rem'}}>Profile after deletion will <strong>inexperienced</strong>.</p>
                                    </div>
                                    <div class="form-inline" style={{marginLeft: '135px'}}>
                                        <button type='submit' class="btn btn-success" style={{marginRight: '20px'}}><i class="far fa-check-circle"></i> Agree</button>	
