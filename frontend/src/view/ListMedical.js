        ...
        return(
            <div>
                <div className='form-inline'>
                    <h1 style={{padding: 20}}>Patient records</h1>
                    <a href="#" style={{marginLeft: '32%', marginRight: 10}}><button type="button" className='btn btn-dark' data-bs-toggle="modal" data-bs-target="#myModal"><i class="fas fa-user-plus"></i>Add records</button></a>
                    <button type="button" className='btn btn-success'><i class="fas fa-file-download"></i> Download</button>
                    <div class="input-group mb-3" style={{paddingTop: 16, marginLeft: '10px'}}>
                        <input type="text" id='find' class="form-control" placeholder="Search..." style={{borderRight: 0 }} onKeyUp={findData}/>
                    ...
                    <table id='lis-ps' class="table table-bordered" style={{backgroundColor: 'white'}}>
                        <thead>
                            <tr style={{textAlign: 'center'}}>
                                ...
                                <th>Tên</th>
                                <th style={{width: 150}}>Sex</th>
                                <th style={{width: 200}}>Date of isolation</th>
                                <th>Health status</th>
                ...
                <div class="modal fade" id="myModal">
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title"><i class="fas fa-plus-square"></i> Add patient records</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <form style={{paddingLeft: 50, paddingRight: 50}} onSubmit={this.handleSubmit}>
                                ...
                                <div className='form-inline' style={{marginTop: 20}}>
                                    <label for="day" className="form-label">Date of isolation:</label>
                                ...
                                <div className="form-inline" style={{marginTop: 20}}>
                                    <label for="devices" className="form-label">Device:</label>
                                ...
                                <div style={{marginTop: 20}}>
                                    <label for="symptom">Initial symptoms:</label>
                                ...
                                <button type="submit" className='btn btn-dark' style={{marginTop: 20}}><i class="fas fa-plus-circle"></i> More</button>
                            </form>
                        </div>
