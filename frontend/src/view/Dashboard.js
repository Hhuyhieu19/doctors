                        ...
                        <div id='title-us' className='container-fluid'>
                            <div className='row'>
                                <div className='col-sm-7'>
                                    <p style={{fontSize: 40, paddingLeft: 20, paddingTop: 40}}>Hello doctor</p>
                        ...
                        <div id='clock'>
                            <h2 style={{textAlign: "center", paddingTop: 15}}> 
                                <form className='form-inline' style={{marginLeft: '25%'}}>
                                  <p>Day</p>  <p id='day' style={{marginRight: 5, marginLeft: 5}}>{day}</p> <p>month</p> <p id='month' style={{marginLeft: 5, marginRight: 5}}>{month}</p> <p>year</p> <p id='year' style={{marginLeft: 5}}>{year}</p>
                                </form> 
                            </h2>
                        </div>
                        <div className='row'>
                            <div className='col'>
                                <div id='count-ps'>
                                    <h4 style={{textAlign: "center", paddingTop: 10}}>Current patient</h4>
                                    <h1 style={{textAlign: 'center', marginTop: '30px'}}>{this.state.count.current}</h1>
                                </div>
                            </div>
                            <div className='col'>
                                <div id='sum-ps'>
                                    <h4 style={{textAlign: "center", paddingTop: 10}}>Total number of patients</h4>
