                ...
                <div id='bg-log' className='bodies'>
                    <div style={{paddingTop: 90}}>
                        <form id='form' className='form' onSubmit={this.handleLogin}>
                            <h3 style={{textAlign: "center", paddingTop: 30}}>Log in</h3>
                            <div className="mb-3 mt-3" style={{paddingLeft: 50, paddingRight: 50}}>
                                <input type="text" class="form-control" id="usn" placeholder="Account name..." name="username" onChange={(e)=>this.setState({username:e.target.value})} required/>
                            </div>
                            <div className="input-group" style={{paddingLeft: 50, paddingRight: 50}}>
                                <input type="password" className="form-control" id='pw' name='password' placeholder="Password..." style={{borderRight: 0}} onChange={(e)=>this.setState({password:e.target.value})} required/>
                            ...
                            <button type="submit" className='btn btn-primary' id='login' style={{ marginTop: 25, width: 450, marginLeft: 50 }}>Log in</button>
                            <br></br>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="w3-panel w3-pale-red w3-leftbar w3-rightbar w3-border-red">
                                    ...
                                    <p style={{color: 'red', marginLeft: '2rem'}}><strong>Login failed!!!</strong></p>
                                </div>                              
                            </div>
                            ...
                            <div className="modal-body">
                                <div class='w3-container'>
                                    <div class='form-inline' style={{marginTop: '20px', marginBottom: '20px'}}>
                                        ...
                                        <h3 style={{textAlign: 'center'}}>You log in successfully</h3>
                                    </div>
                                    <button type="button" id='btn-log' className='btn btn-success' style={{width: '100%'}}>Accept</button>  
                                </div>
                            </div>
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <div class='form-inline' style={{marginTop: '20px', marginBottom: '20px'}}>
                                        ...
                                        <h3 style={{textAlign: 'center'}}>Hello Administrator</h3>
                                    </div>
                                    <button type="button" id='btn-log2' className='btn btn-primary' style={{width: '100%'}}>Accept</button>  
                                </div>
                            </div>
                            <div className="modal-footer">
                            </div>
