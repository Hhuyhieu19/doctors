                ...
                <div className='container-fluid'>
                            ...
                            <div id='ifo-ps' className='container-fluid'>
                                <div className='row'>
                                    <div id='ava' className='col-sm-6'>
                                        ...
                                        <button type="button" className='btn btn-danger' style={{marginLeft: 57}} data-bs-toggle="modal" data-bs-target="#mymodal">Initial symptoms</button>
                                    </div>
                                    <div class="modal" id="mymodal">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Initial symptoms</h4>
                                    ...
                                    <div id='ifor' className='col-sm-6'>
                                        <label for="gen" class="form-label" style={{marginTop: 10}}><strong><i class="fas fa-venus-mars"></i> Sex:</strong></label>
                                        <input type="text" class="form-control" id="gen"  name="gen" value={this.state.patients.sex} disabled/>
                                        <label for="phone" class="form-label" style={{marginTop: 10}}><strong><i class="fas fa-phone"></i> Phone number:</strong></label>
                                        <input type="phone" class="form-control" id="phone"  name="phone" value={this.state.patients.phone} disabled/>
                                        <label for="date" class="form-label" style={{marginTop: 10}}><strong><i class="fas fa-calendar-day"></i> Date of isolation:</strong></label>
                                        <input type="text" class="form-control" id="date"  name="date" value={this.state.patients.day} disabled/>
                                        <label for="addr" class="form-label" style={{marginTop: 10}}><strong><i class="fas fa-map-marked-alt"></i> Address:</strong></label>
                        ...
                        <div className='col-sm-6'>
                            <div id='dnt-dt'>
                                <form onSubmit={this.handleAddDiagnose}>
                                    <div class="container">
                                        <label for="health" class="form-label" style={{marginTop: 10}}><strong><i class="fas fa-medkit"></i> Health status:</strong></label>
                                        ...
                                        <label for="diagnosis"><h5>Diagnostic:</h5></label>
                                        ...
                                        <button className='btn btn-secondary' style={{marginTop: 20}}><a href={"/app/diagnose/"+this.state.patients.id} style={{textDecoration: 'none', color: 'white'}}><i class="fas fa-history"></i> DiagnosisHistory</a></button>
                    ...
                    <div className='row' style={{marginTop: 20}}>
                        <div className='col-sm-4'>
                            <div id='hearth'>
                                <h3 style={{color: 'white', textAlign: 'center', paddingTop: 10}}><i class="fas fa-heartbeat"></i> Heartbeat</h3>
                                <p style={{textAlign: 'center', color: 'white', fontSize: 40, marginTop: 50}}>{this.state.list.heartBeat} BPM</p>
                            </div>
                        </div>
                        <div className='col-sm-4'>
                            <div id='oxy'>
                                <h3 style={{color: 'white', textAlign: 'center', paddingTop: 10}}><img src={oxy} width={50}/> Blood oxygen concentration</h3>
                                <p style={{textAlign: 'center', color: 'white', fontSize: 40, marginTop: 30}}>{this.state.list.oxyBlood} %</p>
                            </div>
                        </div>
                        <div className='col-sm-4'>
                            <div id='temp'>
                                <h3 style={{color: 'white', textAlign: 'center', paddingTop: 10}}><i class="fas fa-temperature-high"></i> Body temperature</h3>
