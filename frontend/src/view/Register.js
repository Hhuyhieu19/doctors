                ...
                <div id='bg-reg' className='body'>
                    <div style={{paddingTop: 100}}>
                        <form id='form-reg' className='form' onSubmit={this.handleRegis}>
                            <h2 style={{textAlign: 'center', paddingTop: 40}}><i class="fas fa-user-edit"></i> Account registration</h2>
                            ...
                            <div className='form-inline' style={{marginTop: 30, paddingLeft: 70}}>
                              <label for="name" className="form-label"> <strong>User name:</strong></label>
                              <input type="text" style={{marginLeft: 10, width: '400px'}} className="form-control" name="name" id="name" placeholder="VD: Nguyen Van A" onChange={(e)=>this.setState({name:e.target.value})} required/>
                            </div>
                            <div className='form-inline' style={{marginTop: 20, paddingLeft: 70}}>
                              <label for="username" className="form-label"><strong>Account name:</strong></label>
                            ...
                            <div style={{marginTop: 20, paddingLeft: 70}}>
                                <button type="submit" className='btn btn-info' style={{color: 'white', width: '520px', backgroundColor: '#1E90FF'}}><i class="fas fa-pencil-alt"></i> Register</button>
                            </div>
                            <div style={{marginTop: 20, paddingLeft: 70, paddingBottom: 50}}>
                                <a href="/login"><i class="fas fa-chevron-left" style={{marginLeft: '28%'}}></i> Back to the login page</a>
                            </div>
                        </form>                      
                    </div>
                </div>
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <div class='w3-container'>
                                    ...
                                    <h2 style={{textAlign: 'center', color: '#32CD32'}}>You have successfully registered</h2>
                                    <div class='w3-panel w3-pale-green w3-leftbar w3-border-green'>
                                        <h5 style={{paddingTop: 20}}><strong>Notification</strong></h5>
                                        <p> <strong>Please return to the login page</strong> </p>
                                    </div>
                                    <button type="button" id='btn-reg' className='btn btn-success' style={{width: '100%'}}>Accept</button>  
                                </div>
                            </div>
