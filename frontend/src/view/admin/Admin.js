            ...
            <Router>
                <div className='container-fluid' style={{margin: 0, padding: 0, boxSizing: 'border-box'}}>
                    <div className='head-admin'>
                        ...
                        <p style={{fontSize: 20, paddingTop: 8, marginLeft: '74%'}}><strong>Administrators</strong></p>
                        ...
                        <div className="row">
                            <div id='side-admin' className='col-sm-2'  style={{margin: 0, padding: 0, boxSizing: 'border-box'}}>
                                <ul id='menu-main' className="nav flex-column"> 
                                    ...
                                    <li className="nav-item">
                                        <a className="nav-link" href="/admin/account" style={{marginTop: '20px'}}><i class="fas fa-users-cog"></i> Account management</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link" href="/login" style={{marginTop: '20px'}}><i class="fas fa-sign-out-alt"></i> Log out</a>
                                    </li>
                                </ul>
                            </div>
