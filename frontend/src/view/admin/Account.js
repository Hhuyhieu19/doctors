                ...
                return (
                    <tbody style={{textAlign: 'center'}}>
                        <tr key={i}>
                            ...
                            <td>{object.role}</td>
                            <td><button type="button" className='btn btn-danger' data-bs-toggle="modal" data-bs-target={"#myModal"+object.id}>Delete</button></td>
                        </tr>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form onSubmit={this.handleDelete}>
                                            ...
                                            <h4 style={{textAlign: 'center',}}>Are you sure you want to delete this account?</h4>
                                            <p style={{textAlign: 'center'}}>Please enter again <strong className='text-danger' style={{fontSize: 18}}>{object.id}</strong> enter <strong>cell below</strong> To delete this account</p>
                                            <div className='form-inline' style={{paddingLeft: 27}}>
                                                <label for="id">Application code: </label>
