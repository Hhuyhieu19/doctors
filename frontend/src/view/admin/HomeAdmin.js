        ...
        return(
            <div>
                <div style={{display: 'inline-flex'}}>
                    <div className='box-1'>
                        <h4 style={{textAlign: 'center', paddingTop: 10}}>Total account number</h4>
                        <p style={{fontSize: 50, textAlign: 'center'}}> <strong>{this.state.count.count}</strong> </p>
                    </div>
                    <div className='box-2'>
                        <h4 style={{textAlign: 'center', paddingTop: 10}}>Doctor's account number</h4>
                        <p style={{fontSize: 50, textAlign: 'center'}}> <strong>{this.state.count.doctor}</strong> </p>
                    </div>
                    <div className='box-3'>
                        <h4 style={{textAlign: 'center', paddingTop: 10}}>Patient account number</h4>
