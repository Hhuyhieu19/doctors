          ...
          <div className='header'>
            <nav class="navbar navbar-expand-lg navbar-light">
              ...
              <div id='logout' style={{border: '0px solid black', textAlign: 'center', marginLeft: '1200px'}}>
                <a className="nav-link" id='logout' href="/login" style={{padding: 10}} onClick={this.hanleLogout}><i class="fas fa-sign-out-alt" style={{marginRight: 10}}></i> Log out</a>
              </div>
            </nav>
          </div>
            ...
            <div className='row'>
              <div id='sidebar' className='col-sm-2'>
                <ul id='menu-main' className="nav flex-column">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="/app/medical" style={{marginTop: '20px'}}><i class="fas fa-notes-medical" style={{marginRight: 10}}></i> Examination records</a>
                  </li>
                </ul>
              </div>
